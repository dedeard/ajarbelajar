...
<div class="container-fluid">
  <div class="card card-block mt-15">
    ...
    <h4>Kurang sreg nih sama sistem AjarBelajar sekarang...</h4>
    <p>Kami terbuka untuk feedback yang konstruktif! Kamu bisa isi form disini. Atau kamu punya ide yang keren dan mau membantu mengimplementasikannya? Kontak ajarbelajarcom@gmail.com apabila tertarik membantu tim AjarBelajar untuk perubahan positif yang lebih dahsyat!</p>

    <h4>Apa prospek dan rencana jangka panjang AjarBelajar?</h4>
    <p>Perubahan besar menanti Indonesia. Jika jutaan awardee beasiswa luar negeri, mahasiswa universitas luar dan dalam negeri, alumni yang ingatannya masih fresh tentang bidangnya, semua berbagi ilmu dan insight keren yang bisa dipakai dibidang lain, pasti kualitas pendidikan Indonesia meningkat. Anak SMA termotivasi untuk mengedepankan ilmu lebih daripada hanya job-oriented, asisten dosen terbantu mengingat kembali bahan ajarnya, terciptanya kolaborasi lintas bidang... dan masih banyak lagi! Hal-hal besar tersebut bisa dimulai dengan kamu berkontribusi membuat keluarga AjarBelajar semakin keren lagi.</p>
    <br><br>
    <p>Punya pertanyaan lain yang belum ada di sini? Silahkan hubungi ajarbelajarcom@gmail.com :)</p>
  </div>
</div>
@endsection