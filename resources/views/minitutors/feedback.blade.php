        ...
        <div class="feedback-row">
          <div v-if="!showDetail" class="feedback-row-info">
            ...
            <div class="feedback-row-right">
              ...
              <star-rating class="line-height-1 feedback-row-info-rating" :rating="{{ $feedback->rating }}" :read-only="true" :increment="0.01" :star-size="16" text-class="mt-0 font-weight-bold">
              </star-rating>
          ...
          <div class="feedback-row-action">
            <button type="button" class="btn btn-default btn-sm btn-sm btn-block" @click="showDetail = !showDetail">
