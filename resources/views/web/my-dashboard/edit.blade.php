...
<div class="container-fluid my-dashboard-layout">
  <div class="panel">
    <div class="panel-body">
      <form class="row" action="{{ route('dashboard.me.edit.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="col-lg-3 mb-30">
          <avatar-uploader inline-template>
            <div class="ab-avatar-uploader">
              <span class="avatar img-bordered bg-light">
                <img :src="url || '{{ Auth::user()->imageUrl() }}'" alt="{{ Auth::user()->username }}">
              </span>
              <button class="btn btn-light btn-sm btn-floating" @click="handleClick"><i class="icon wb-image"></i></button>
              <input type="file" name="image" class="ab-avatar-uploader-input" ref="input" @change="handleChange">
