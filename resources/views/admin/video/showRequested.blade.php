...
<div class="panel">
  <div class="panel-heading">
    ...
    <div class="panel-actions">
      <div class="btn-group">
        <a href="{{ route('admin.video.requested.accept', $video->id) }}" class="btn btn-outline btn-default btn-sm">Terima</a>
        <a href="{{ route('admin.video.requested.reject', $video->id) }}" class="btn btn-outline btn-default btn-sm">Tolak</a>
      </div>
    </div>
  </div>
