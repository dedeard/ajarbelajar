    ...
    <div class="panel panel-bordered">
      <div class="panel-heading">
        ...
        <div class="panel-actions">
          <a href="{{ route('admin.minitutors.requests') }}" class="btn btn-sm btn-danger">Requested</a>
        </div>
      </div>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle"><a href="{{ route('admin.minitutors.show', $minitutor->id) }}">{{ $minitutor->user->name() }}</a></td>
              ...
              <td class="text-center p-0 align-middle">
                <a href="{{ route('admin.minitutors.show', $minitutor->id) }}" class="btn btn-outline-default btn-sm btn-icon"><i class="wb-eye"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
