  ...
  <form action="{{ route('dashboard.lessons.update', $lesson->id) }}" method="POST">
    ...
    <div class="border-b p-3">
      ...
      <x-input-wrap label="Deskripsi" useDiv>
        <livewire:markdown-editor name="description" :value="$lesson->description" :disabled-tools="['heading', 'blockquote', 'table', 'horizontalRule']" />
      </x-input-wrap>
      <div class="flex items-center py-3">
        ...
        <label for="public-checkbox" class="ml-2 text-sm font-medium text-gray-900">Publikasikan
          pelajaran</label>
      </div>
    </div>
    <div class="p-3">
