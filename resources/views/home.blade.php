<x-app-layout title="Belajar, Berbagi, Berkontribusi">
  ...
  <div class="container mb-3 p-3">
    <h3 class="text-xl font-semibold uppercase tracking-wider">Pelajaran terbaru
    </h3>
  ...
  <div class="container p-3">
    <h3 class="text-xl font-semibold uppercase tracking-wider">Kategori populer
    </h3>
    <div class="grid grid-cols-1 gap-3 py-3 md:grid-cols-2 xl:grid-cols-4">
  ...
  <div class="container p-3">
    <h3 class="text-xl font-semibold uppercase tracking-wider">Pengguna baru
    </h3>
    <div class="grid grid-cols-1 gap-3 py-3 md:grid-cols-2 xl:grid-cols-4">
