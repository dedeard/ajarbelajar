  ...
  <div class="container-fluid">
    <div class="panel panel-bordered">
      <div class="panel-heading">
        <h3 class="panel-title">Pilih MiniTutor penulis artikel</h3>
        <div class="panel-actions">
          <a href="{{ route('articles.index') }}" class="btn btn-sm btn-primary">Batal</a>
        </div>
      </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center p-0 align-middle">
                <a href="{{ route('articles.create', ['id' => $minitutor->id]) }}" class="btn btn-outline-default btn-sm">Pilih</a>
              </td>
            </tr>
            @endforeach
          </tbody>
