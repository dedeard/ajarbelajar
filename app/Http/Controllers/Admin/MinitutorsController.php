...
class MinitutorsController extends Controller
{
    ...
    public function showArticles($id)
    {
        $minitutor = Minitutor::findOrFail($id);
        $user = $minitutor->user;
        $articles = $minitutor->articles()->get();
    ...
    public function showVideos($id)
    {
        $minitutor = Minitutor::findOrFail($id);
        $user = $minitutor->user;
        $videos = $minitutor->videos()->get();
        return view('minitutors.videos', ['minitutor' => $minitutor, 'user' => $user, 'videos' => $videos]);
    }
    ...
    public function showFollowers($id)
    {
        $minitutor = Minitutor::findOrFail($id);
        $user = $minitutor->user;
        $followers = $minitutor->followers()->with('user')->get();
