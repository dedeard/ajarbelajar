  ...
  <ul class="ab-dashboard__nav-quick nav-quick nav-quick-sm row">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.edit') ? 'active' : '' }}"
        href="{{ route('dashboard.edit') }}" data-toggle="tooltip" title="Edit profil kamu.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.following') ? 'active' : '' }}"
        href="{{ route('dashboard.following') }}" data-toggle="tooltip" title="Daftar MiniTutor yang Kamu ikuti.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.favorite*') ? 'active' : '' }}"
        href="{{ route('dashboard.favorite') }}" data-toggle="tooltip" title="Daftar artikel dan video Favorit Kamu.">
  ...
  <ul class="ab-dashboard__nav-quick nav-quick nav-quick-sm row">
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.accepted*') ? 'active' : '' }}"
        href="{{ route('dashboard.accepted.index') }}" data-toggle="tooltip" title="Daftar artikel dan video kamu yang telah diterima.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.requested*') ? 'active' : '' }}"
        href="{{ route('dashboard.requested.index') }}" data-toggle="tooltip" title="Daftar artikel dan video kamu yang sedang menunggu untuk di publish.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.comments*') ? 'active' : '' }}"
        href="{{ route('dashboard.comments.index') }}" data-toggle="tooltip" title="Daftar Komentar yang ada pada artikel dan video kamu yang telah diterima.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.review*') ? 'active' : '' }}"
        href="{{ route('dashboard.review.index') }}" data-toggle="tooltip" title="Daftar Feedback yang ada pada artikel dan video kamu yang telah diterima.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.article*') ? 'active' : '' }}"
        href="{{ route('dashboard.article.index') }}" data-toggle="tooltip" title="Daftar artikel yang sedang kamu kelola.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.video*') ? 'active' : '' }}"
        href="{{ route('dashboard.video.index') }}" data-toggle="tooltip" title="Daftar video yang sedang kamu kelola.">
    ...
    <li class="nav-item col">
      <a class="nav-link {{ Route::is('dashboard.followers*') ? 'active' : '' }}"
        href="{{ route('dashboard.followers.index') }}" data-toggle="tooltip" title="Daftar pengguna yang telah mengikuti kamu.">
