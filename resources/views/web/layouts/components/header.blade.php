    ...
    <div class="ab-header__left">
      <div class="container-fluid">
        <div class="ab-header__left-wrapper">
          ...
          <a href="#" class="ab-header__sidebar-toggle d-block d-lg-none" @click="formSearchToggleClick">
      ...
      <div class="container-fluid">
        <div class="ab-header__right-wrapper">
          ...
          <div class="ab-header__right-avatar">
            <a class="avatar img-bordered bg-white" href="javascript:;">
            ...
            <div class="ab-profile-dropdown">
              ...
              <div class="ab-profile-dropdown__wrapper">
                <div class="card m-0">
                  ...
                  <div class="card-body">
                    <a href="{{ route('dashboard.me.index') }}" class="btn btn-inverse btn-block">Dashboard</a>
                    <a href="{{ route('dashboard.me.edit.index') }}" class="btn btn-inverse btn-block">Edit profile</a>
                  </div>
